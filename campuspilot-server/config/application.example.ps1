...
$env:KINGDEE_BASE_URL = 'http://10.0.160.11:8881/ierp'
$env:KINGDEE_ACCESS_TOKEN = ''
$env:KINGDEE_CLIENT_ID = 'code_campus_pilot'
$env:KINGDEE_CLIENT_SECRET = ''
$env:KINGDEE_USERNAME = '17299999999'
$env:KINGDEE_ACCOUNT_ID = '1565321489509515264'
